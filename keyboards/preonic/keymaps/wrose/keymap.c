...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   *                |-----------------------------------------------------------------------|
   * Tap for Esc -- |Ctrl | A   | S   | D   | F   | G   | H   | J   | K   | L   |; Fn4| '   |
   *                |-----------------------------------------------------------------------|
   *                |Shift| Z   | X   | C   | V   | B   | N   | M   | ,   | .   | /   |Shift| -- Tap for Enter
   *                |-----------------------------------------------------------------------|
   *                | Ctrl|     | Alt |Super| Fn1 |   Space   | Fn2 |Left | Down| Up  | Rght|
   *                `-----------------------------------------------------------------------'
   *
   */
  [BASE_QWERTY_LAYER] = {
    ...
    {F(5),    KC_A,           KC_S,          KC_D,    KC_F,  KC_G,   KC_H,    KC_J,  KC_K,    KC_L,          KC_SCLN,           KC_QUOT},
    {KC_LSFT, KC_Z,           KC_X,          KC_C,    KC_V,  KC_B,   KC_N,    KC_M,  KC_COMM, KC_DOT,        KC_SLSH,        F(6)},
    {KC_LCTL, ___x___,            KC_LALT,       KC_LGUI, LOWER, KC_SPC, KC_SPC,  RAISE, KC_LEFT, KC_DOWN,       KC_UP,          KC_RGHT}
  },
  ...
  [LOWER_LAYER] = {
    ...
    {_______,      KC_MINS,        KC_EQL,        KC_GRV,  KC_BSLS, ___x___, KC_LBRC,       KC_RBRC,          KC_COMM, KC_DOT,        KC_SLSH,        _______},
  ...
  [RAISE_LAYER] = {
    ...
    {_______, KC_UNDS, KC_PLUS, KC_TILD, KC_PIPE, ___x___, S(KC_LBRC),    S(KC_RBRC),       KC_COMM, KC_DOT,  KC_SLSH,    _______},
  ...
  [KEYBOARD_LAYER] = {
    ...
    {___x___, ___x___, MAGIC_SWAP_LALT_LGUI, MAGIC_UNSWAP_LALT_LGUI, LOWER,   BL_TOGG, BL_TOGG, RAISE,   BL_TOGG, BL_DEC,  BL_INC,  ___x___}
  }
};
